 ...
 */
declare const createUseRealm: (RealmContext: React.Context<Realm$1 | null>) => () => Realm$1;

type RealmClassType<T = any> = {
    new (...args: any): T;
};
type QueryCallback<T> = (collection: Realm$1.Results<T>) => Realm$1.Results<T>;
 ...
 */
declare function createUseQuery(useRealm: () => Realm$1): {
    <T>(type: string, query?: QueryCallback<T> | undefined, deps?: DependencyList): Realm$1.Results<T & Realm$1.Object<T>>;
    <T_1 extends Realm$1.Object<any>>(type: RealmClassType<T_1>, query?: QueryCallback<T_1> | undefined, deps?: DependencyList): Realm$1.Results<T_1>;
};
 ...
 */
declare function createUseObject(useRealm: () => Realm$1): {
    <T>(type: string, primaryKey: T[keyof T]): (T & Realm$1.Object<T>) | null;
    <T_1 extends Realm$1.Object<any>>(type: new (...args: any) => T_1, primaryKey: T_1[keyof T_1]): T_1 | null;
};

type PartialRealmConfiguration = Omit<Partial<Realm$1.Configuration>, "sync"> & {
    sync?: Partial<Realm$1.SyncConfiguration>;
};
type ProviderProps = PartialRealmConfiguration & {
    /**
     * The fallback component to render if the Realm is not opened.
     */
    fallback?: React__default.ComponentType<unknown> | React__default.ReactElement | null | undefined;
    /**
     ...
     */
    realmRef?: React__default.MutableRefObject<Realm$1 | null>;
 ...
 */
declare function createRealmProvider(realmConfig: Realm$1.Configuration, RealmContext: React__default.Context<Realm$1 | null>): React__default.FC<ProviderProps>;

declare enum AuthOperationName {
    LogIn = "logIn",
 ...
 */
type AppProviderProps = Realm$1.AppConfiguration & {
    /**
     ...
     */
    appRef?: React__default.MutableRefObject<Realm$1.App | null>;
    children: React__default.ReactNode;
};
/**
 ...
 */
declare const AppProvider: React__default.FC<AppProviderProps>;
/**
 ...
 */
declare const useApp: <FunctionsFactoryType extends Realm$1.DefaultFunctionsFactory, CustomDataType extends Record<string, unknown>>() => Realm$1.App<FunctionsFactoryType, CustomDataType>;
declare const useAuthResult: () => [OperationResult, React__default.Dispatch<React__default.SetStateAction<OperationResult>>];
...
/** @public */
declare type BinarySequence = Uint8Array | Buffer | number[];
...
declare namespace EJSON {
    ...
    export type SerializableTypes = Document$1 | Array<JSONPrimitive | Document$1> | JSONPrimitive;
    /**
     ...
     */
    export function serialize(value: SerializableTypes, options?: EJSON.Options): Document$1;
    /**
     ...
     */
    export function deserialize(ejson: Document$1, options?: EJSON.Options): SerializableTypes;
}

/** @public */
declare type EJSONOptions = EJSON.Options;
...
/** @public */
declare type LongWithoutOverrides = new (low: unknown, high?: number, unsigned?: boolean) => {
...
declare namespace BSON {
    const ObjectId: typeof ObjectId;
    type ObjectId = ObjectId;
    const ObjectID: typeof ObjectId;
    type ObjectID = ObjectId;
    const Decimal128: typeof Decimal128;
    type Decimal128 = Decimal128;
    const UUID: typeof UUID;
    type UUID = UUID;
    const Binary: typeof Binary;
    type Binary = Binary;
    const EJSON: typeof EJSON;
 ...
 */
declare const UserProvider: React__default.FC<UserProviderProps>;
/**
 ...
 *
 */
declare const useUser: <FunctionsFactoryType extends DefaultFunctionsFactory, CustomDataType extends Record<string, unknown>, UserProfileDataType extends DefaultUserProfileData>() => User<FunctionsFactoryType, CustomDataType, UserProfileDataType>;
...
interface UseAuth {
     ...
     */
    logIn(credentials: Realm$1.Credentials): void;
    /**
 ...
 */
declare function useEmailPasswordAuth(): UseEmailPasswordAuth;
 ...
 */
declare const createRealmContext: (realmConfig?: Realm$1.Configuration) => RealmContext;
/**
 * The Provider component that is required to wrap any component using
 * the Realm hooks.
 * @example
 ...
 */
declare const RealmProvider: React$1.FC<Omit<Partial<Realm$1.Configuration>, "sync"> & {
    sync?: Partial<Realm$1.SyncConfiguration> | undefined;
} & {
    fallback?: React$1.ReactElement<any, string | React$1.JSXElementConstructor<any>> | React$1.ComponentType<unknown> | null | undefined;
    closeOnUnmount?: boolean | undefined;
    realmRef?: React$1.MutableRefObject<Realm$1 | null> | undefined;
 ...
 * @returns a realm instance
 */
declare const useRealm: () => Realm$1;
/**
 * Returns a {@link Realm.Collection} of {@link Realm.Object}s from a given type.
 * The hook will update on any changes to any object in the collection
 * and return an empty array if the collection is empty.
...
declare const useQuery: {
    <T>(type: string, query?: ((collection: Realm$1.Results<T>) => Realm$1.Results<T>) | undefined, deps?: readonly unknown[] | undefined): Realm$1.Results<T & Realm$1.Object<T>>;
    <T_1 extends Realm$1.Object<any>>(type: new (...args: any) => T_1, query?: ((collection: Realm$1.Results<T_1>) => Realm$1.Results<T_1>) | undefined, deps?: readonly unknown[] | undefined): Realm$1.Results<T_1>;
};
/**
 * Returns a {@link Realm.Object} from a given type and value of primary key.
 * The hook will update on any changes to the properties on the returned object
